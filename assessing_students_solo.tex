...
\usepackage[hmarginratio=1:1,left=18mm,right=18mm,top=28mm,bottom=24mm,columnsep=20pt]{geometry} % Document margins
...
\end{axis}
\end{tikzpicture}
\caption{SOLO level compared to final grade in javascript1.}
...
\end{axis}
\end{tikzpicture}
\caption{SOLO levels compared to final grade in linux.}
\label{figlinux}
\end{figure}

A comparison of SOLO levels and final grades are summarized in table \ref{table:sum} and a relative comparison of SOLO levels and final grades is shown in \ref{table:percentage}.

\begin{table}[H]
\caption{Comparison of SOLO levels and final grades.}
\centering
\begin{tabular}{c | c c c c}
