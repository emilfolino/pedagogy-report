...
=======
\noindent In this paper a method of qualitative assessment of programming students is investigated. The qualitative assessment is done by reading students' review text from a programming project and analyzing the text according to the SOLO taxonomy.
>>>>>>> Stashed changes
\end{abstract}
}
