...
\begin{abstract}
\noindent In this paper a method of qualitative assessment of programming student is investigated. The qualitative assessment is done by reading students' review text from programming projects and analyzing the content according to the SOLO taxonomy.
\end{abstract}
}
