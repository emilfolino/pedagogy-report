...
\noindent In this paper a method of qualitative assessment of programming student is investigated. The qualitative assessment is done by reading students' review texts from individual programming projects and analyzing the content according to the SOLO taxonomy. The students are awarded a SOLO level of \textbf{Relational}, \textbf{Multistructural}, or \textbf{Unistructural}. The SOLO level is compared to the final grade of the courses and a correlation between a students final grade and the SOLO level is shown. Furthermore a positive progression in the students' comprehension and understanding of the course material and in programming in general is observed.
...
Figure \ref{figcomparison} shows the relationship between SOLO level and the three subsequent courses.

\begin{figure}
\begin{tikzpicture}
\begin{axis}[
    title={SOLO level compared to courses},
    xlabel={Courses},
    ylabel={SOLO level},
    xmin=1, xmax=3,
    ymin=0, ymax=5,
...
\addplot coordinates {(1,3)(2,3)(3,4)};
\addplot coordinates {(1,3)(2,3)(3,4)};
\addplot coordinates {(1,3)(2,3)(3,4)};
\addplot coordinates {(1,3)(2,4)(3,4)};
\addplot coordinates {(1,3)(2,4)(3,4)};
\addplot coordinates {(1,2)(2,3)(3,3)};
\addplot coordinates {(2,3)(3,4)};
\addplot coordinates {(1,4)(3,4)};
\addplot coordinates {(1,4)(3,3)};
\addplot coordinates {(1,3)(2,2)(3,4)};
\addplot coordinates {(1,2)(2,4)(3,3)};
\addplot coordinates {(1,3)(3,3)};
\addplot coordinates {(1,2)(2,3)(3,3)};
\addplot coordinates {(1,4)(2,3)(3,4)};
\addplot coordinates {(1,3)(2,3)(3,3)};
\addplot coordinates {(1,2)(2,4)};
\legend{28387421,2e28c990,3fdbd61e,5c75c9f1,5dcabbe7,68cc03f0,7143f813,7b8fb884,857d5208,95dcad6b,c68f38bd,d112ecf7,d5ccca2a,e18da383,ebbf7c6b,ebf3313e,f247d83f}

\end{axis}
\end{tikzpicture}
\caption{SOLO grades over time.}
\label{figcomparison}
\end{figure}
